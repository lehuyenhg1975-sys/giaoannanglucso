...
<div class="main-header">
    ...
    <p>Tác giả: Lê Thị Thanh Huyền - Trường Tiểu học Ngọc Đường - ĐT: 0345483919</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Thị Thanh Huyền - Trường Tiểu học Ngọc Đường - ĐT: 0345483919</div>", unsafe_allow_html=True)
